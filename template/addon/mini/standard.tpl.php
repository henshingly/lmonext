<!--
  Template: addon/mini | Filename: standard.tpl.php | Fileversion: 1.0.0
...
-->
<style>
.lmo-mini{font-family:'Segoe UI',system-ui,-apple-system,sans-serif;border-collapse:collapse;
...
.lmo-mini td.lmo-mini-team{text-align:left}
...
.lmo-mini-foot{font-size:.68rem;color:#9098a8;text-align:right;padding:4px 8px 0}
</style>
