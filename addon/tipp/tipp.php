...
// ═══════════════════════════════════════════════════════════════════════
  ...
  <p style="font-size:.85rem"><a href="?action=abgabe"><?= h(tf('tf_tipp_zur_abgabe')) ?></a> — <a href="?action=logout"><?= h(tf('tf_tipp_logout')) ?></a></p>
...
<?php
  ...
  <p style="font-size:.85rem"><?= h(tf('tf_tipp_eingeloggt_als')) ?> <strong><?= h($tipper['nickname']) ?></strong> — <a href="?action=einsicht"><?= h(tf('tf_tipp_einsicht_titel')) ?></a> — <a href="?action=logout"><?= h(tf('tf_tipp_logout')) ?></a></p>
